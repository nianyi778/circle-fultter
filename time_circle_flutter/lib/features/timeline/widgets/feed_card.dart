...
class _FeedCardState extends ConsumerState<FeedCard> with SingleTickerProviderStateMixin {
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            Iconsax.more,
                            size: 20,
                            color: _isMenuOpen ? AppColors.warmGray600 : AppColors.warmGray300,
                          ),
                        ),
                      ),
                    ],
                              ...
                              builder: (context, child) {
                                return Transform.scale(
                                  ...
                                  child: Icon(
                                    ...
                                    size: 20,
                                    color: moment.isFavorite ? AppColors.heart : AppColors.warmGray400,
                                  ),
                                );
                              },
                            ),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      height: 40,
                      decoration: BoxDecoration(
                        color: isShared ? AppColors.warmGray200 : AppColors.warmGray50,
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
                        isShared ? Iconsax.eye_slash : Iconsax.global,
                        size: 20,
                        color: isShared ? AppColors.warmGray500 : AppColors.warmGray600,
                      ),
                    ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.only(
                    ...
                    topLeft: onShareToWorld == null ? const Radius.circular(16) : Radius.zero,
                    topRight: onShareToWorld == null ? const Radius.circular(16) : Radius.zero,
                  ),
                ),
                child: Row(
